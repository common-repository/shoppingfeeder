...
//                $products = array( $product_model->get_product( $product_id, null, $price_currency, $price_currency_rate, $allow_variants, $overrideCurrencyConversion ) );
	...
	public function debug() {
        ...
        try
        {
	        ...
	        {
		        echo 'Product Model Not VALID: [' . print_r($product_model, true) . ']' . "<br>\n";
	        }
	        ...
	        {
		        echo '<span style="color:red;">NO PRODUCTS LOADED</span>';
	        }
        } catch (Throwable $eProduct) {
	        echo 'PRODUCT THROWABLE: <span style="color:red;">'.$eProduct->getMessage().'</span>';
        }
